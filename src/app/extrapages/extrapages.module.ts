...
@NgModule({
  ...
  declarations: [MaintenanceComponent, Page404Component, Page403Component, Page500Component, LockscreenComponent, Lockscreen2Component, ConfirmmailComponent, Confirmmail2Component, VerificationComponent, Verification2Component, SteptwoverificationComponent, Steptwoverification2Component, ComingsoonComponent],
  imports: [
    CommonModule,
    RouterModule,
    ReactiveFormsModule,
